...
<form method="post" action="weddincard.php">
    ...
    <div class="form-group">
        <label for="holiday" class="form-label">Holiday to be celebrated</label>
        <input required type="text" class="form-control" id="holiday" name="holiday">
    </div>
    <br />

    <div class="form-group">
        <label for="date" class="form-label">Date of the Holiday celebration</label>
        <input required type="text" class="form-control" id="date" name="date">
    </div>
    <br />

    <div class="form-group">
        <label for="venue" class="form-label">Venue of the Holiday celebration</label>
        <input required type="text" class="form-control" id="venue" name="venue">
    </div>
    <br />

    <div class="form-group">
        <label for="time" class="form-label">Time of the Holiday celebration</label>
