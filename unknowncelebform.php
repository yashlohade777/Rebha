...
<form method="post" action="weddincard.php">
    ...
    <div class="form-group">
        <label for="occasion" class="form-label">occasion of the Party</label>
        <input required type="text" class="form-control" id="occasion" name="occasion">
    </div>
    <br />

    <div class="form-group">
        <label for="date" class="form-label">Date of the Party</label>
        <input required type="text" class="form-control" id="date" name="date">
    </div>
    <br />

    <div class="form-group">
        <label for="venue" class="form-label">Venue of the Party</label>
        <input required type="text" class="form-control" id="venue" name="venue">
    </div>
    <br />

    <div class="form-group">
        <label for="time" class="form-label">Time of the Party</label>
