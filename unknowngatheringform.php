...
<form method="post" action="weddincard.php">
    ...
    <div class="form-group">
        <label for="type" class="form-label">Type of Gathering being organized</label>
        <input required type="text" class="form-control" id="type" name="type">
    </div>
    <br />

    <div class="form-group">
        <label for="reference" class="form-label">Refernce to the Gathered Group</label>
        <input required type="text" class="form-control" id="reference" name="reference">
    </div>
    <br />

    <div class="form-group">
        <label for="date" class="form-label">Date of the Gathering</label>
        <input required type="text" class="form-control" id="date" name="date">
    </div>
    <br />

    <div class="form-group">
        <label for="venue" class="form-label">Venue of the Gathering</label>
        <input required type="text" class="form-control" id="venue" name="venue">
    </div>
    <br />

    <div class="form-group">
        <label for="time" class="form-label">Time of the Gathering</label>
